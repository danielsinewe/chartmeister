...
var $id = "https://github.com/danielsinewe/chartmeister/chartmeister-schema.json";
var title = "Chartmeister File Format Schema";
var description = "JSON schema for .chartmeister files - a format for saving and loading chart data, similar to Excalidraw's .excalidraw format. Version 6 adds font size overrides for value labels, category labels, axis labels, and legend labels for typography harmonization.";
var version = 6;
var type = "object";
var required = [
	"type",
...
var properties = {
	about: {
		type: "object",
		description: "Optional metadata about this chart file for provenance and sharing",
		properties: {
			title: {
				type: "string"
			},
	...
	version: {
		type: "integer",
		minimum: 1,
		description: "The version of the Chartmeister schema. Version 6 adds font size overrides (valueLabelFontSize, categoryLabelFontSize, axisLabelFontSize, legendLabelFontSize) for typography harmonization. Version 5 added metadata and legend typography. Version 4 adds valueLabelDockMode and clarifies anchored totals."
	},
	source: {
		type: "string",
							...
							items: {
								...
								properties: {
									...
									valueLabelDockMode: {
										...
										description: "Preferred snap placement for the segment value label"
									}
								}
							},
							computeTotal: {
						...
						chartVisual: {
							...
							properties: {
								...
								legendRows: {
									type: "number",
									minimum: 0,
									description: "Preferred legend rows (advisory)"
								},
								legendColumns: {
									type: "number",
									minimum: 0,
									description: "Preferred legend columns (advisory)"
								},
								legendMaxWidth: {
									type: "number",
									minimum: 0,
								...
								valueLabelFontSize: {
									type: "number",
									minimum: 1,
									description: "Font size override for value labels on bars (overrides responsive default)"
								},
								categoryLabelFontSize: {
									type: "number",
									minimum: 1,
									description: "Font size override for category (X-axis) labels (overrides responsive default)"
								},
								axisLabelFontSize: {
									type: "number",
									minimum: 1,
									description: "Font size override for axis tick labels (overrides responsive default)"
								},
								yAxisTickFontFamily: {
									type: "string",
									description: "Font family for Y-axis tick labels (e.g. 'SFMono-Regular', 'Menlo', 'ui-monospace')"
								},
								yAxisTickFontWeight: {
									type: "number",
									minimum: 100,
									maximum: 900,
									description: "Font weight for Y-axis tick labels (e.g. 400, 500)"
								},
								legendPosition: {
									type: "object",
									properties: {
								...
								valueLabels: {
									...
									properties: {
										...
										fontFamily: {
											type: "string",
											description: "Value label font family"
										},
										fontSize: {
											type: "number",
											minimum: 1,
								...
								categoryLabels: {
									...
									properties: {
										...
										fontFamily: {
											type: "string",
											description: "Category label font family"
										},
										fontSize: {
											type: "number",
											minimum: 1,
								...
								yAxis: {
									...
									properties: {
										...
										fontFamily: {
											type: "string",
											description: "Y-axis tick/title font family"
										},
										fontSize: {
											type: "number",
											minimum: 1,
...
type ChartmeisterSchema = typeof schema;
...
declare function validate(file: unknown): ValidationResult;
declare function migrate<T>(file: T): T;

export { type ChartmeisterSchema, type ValidationResult, migrate, schema, schemaVersion, validate };
